    ...
    return (
        <div className="flex ml-6 mr-1">
            ...
            <div style={{ backgroundColor: bgColor }} className={`flex-grow w-4/5 pb-10 rounded-md mt-10`}>
                ...
                <div className={`text-left mx-5 ${textColor} text-xxs sm:text-sm md:text-base lg:text-lg xl:text-xl`}>
                    <br />
                    ...
                    to develop agents that can play games and solve problems. I loved playing games, especially for the sense of progression they
