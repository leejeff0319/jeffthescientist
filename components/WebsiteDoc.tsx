...
type WebsiteDocPageProps = {
    isDarkTheme: boolean;
};

const WebsiteDocPage: React.FC<WebsiteDocPageProps> = ({ isDarkTheme }) => {
    ...
    const docImage = isDarkTheme ? '/Webdoc-Night.PNG' : '/Webdoc-Day.PNG';
    ...
    return (
        <div style={{ background: `${bgColor}` }} className={`w-full mt-20 mb-20 pt-6 pb-6`}>
            ...
            <div className={`flex flex-col w-full items-center ${textColor} text-lg sm:text-xl md:text-3xl lg:text-4xl 2xl:text-5xl mb-2`}>
                <h1><strong>Website Documentation</strong></h1>
            </div>
            ...
            <div className="flex justify-between items-start">
                ...
                <div style={{ background: `${blanketColor}`, width: '700px' }} className="flex p-3 rounded-md ml-2">
                    <Image
                        ...
                        width={700}
                        height={500}
                        alt="Website Documentation Thumbnail"
                    />
                </div>
