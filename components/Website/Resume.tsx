            ...
            <div className="flex mb-4 border-b justify-between text-xxs sm:text-sm md:text-base lg:text-lg xl:text-xl">
                {['education', 'research', 'clinical', 'leadership'].map(tab => (
                    <button
                        ...
                        className={`mr-4 px-4 py-2 ${activeTab === tab ? 'bg-blue-600 text-white rounded-full font-semibold' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-full'}`}
                    >
